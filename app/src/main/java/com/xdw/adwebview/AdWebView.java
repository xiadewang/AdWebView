...
/**
 * Created by xiadewang on 2016/11/2.
 */
public class AdWebView extends WebView {
            ...
            if (resultCode == Activity.RESULT_OK) {
                if (intent != null) {
                    ...
                    if (mFileUploadCallbackFirst != null) {
                        ...
                        Uri[] dataUris;
                        try {
                            Log.e("xdw","DataString="+intent.getDataString());
    ...
    protected void openFileInput(final ValueCallback<Uri> fileUploadCallbackFirst, final ValueCallback<Uri[]> fileUploadCallbackSecond) {
        ...
        if (mFragment != null && mFragment.get() != null && Build.VERSION.SDK_INT >= 11) {
            ...
            mActivity.get().startActivityForResult(i, PHOTOZOOM);
        }
    }
     ...
     * @param fromUrl the URL of the file to download, e.g. the one from `AdWebView.onDownloadRequested(...)`
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, AdWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
